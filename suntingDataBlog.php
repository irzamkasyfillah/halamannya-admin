			...
			<div class="main-content">
				<div class="container-fluid">
                  ...
                  <?php
                    include("koneksi.php");
                    $id = $_GET['id'];
                    $query = "SELECT * FROM data_blog WHERE id='$id'";
                    ...
                    ?>
									<form action="updateDataBlog.php?id=<?php echo $data['id'];?>" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<input name="judul" value="<?php echo $data['judul']; ?>" type="text" class="form-control" id="contact-name" placeholder="Judul Blog">
										</div>
										<div class="form-group">
											<label for="contact-name" class="control-label">Penulis</label>
											<input name="penulis" value="<?php echo $data['penulis']; ?>" type="text" class="form-control" id="contact-name" placeholder="Penulis">
										</div>
										<div class="input-group">
											<label for="contact-date" class="control-label">Tanggal Penulisan</label>
											<input name="tanggal" value="<?php echo $data['tanggal']; ?>" type="date" class="form-control" id="contact-date" value="">
										</div>
										<br>
										<div class="form-group">
											<label for="contact-name" class="control-label">Isi</label>
											<textarea name="isi" class="summernote" style="height: 100px;"><?php echo $data['isi']; ?></textarea>
										</div>
                        ...
                        <br>Ganti gambar?
										    <input name="gambar_baru" value"<?php echo $data['gambar']; ?>" type="file" class="customFile" class="custom-file-input">
										...
										<div class="form-group">
											...
											<select name="kategori" class="form-control" name="jual" id="exampleFormControlSelect1">
												<option class="active"><?php echo $data['kategori']; ?></option>
