...
<body>
	...
	<div id="wrapper">
        ...
        include("koneksi.php");
        $id = $_GET['id'];
        $query = "SELECT * FROM data_panti WHERE id=$id";
        ...
        <form action="updateDataPanti.php?id=<?php echo $data['id'];?>" method="post">
          ...
          <div class="form-group">
            ...
            <select name="kecamatan"  class="form-control" name="jual" id="exampleFormControlSelect1">
              <option class="active"><?php echo $data['kecamatan']; ?></option>
          ...
          <div class="form-group">
            ...
            <select name="kelurahan" class="form-control" name="jual" id="exampleFormControlSelect1">
              <option class="active"><?php echo $data['kelurahan']; ?></option>
          ...
          <div class="form-group">
            ...
            <select name="status_kepemilikan" class="form-control" id="exampleFormControlSelect1">
              <option class="active"><?php echo $data['status_kepemilikan']; ?></option>
